...
const Banner = () => {
    return (
        <div className='d-flex flex-wrap flex-md-nowrap gap-5 mx-5 py-5 align-items-center justify-content-around'>
            <div className='w-100 text-start'>
                ...
                <Link className='btn btn-outline-success' to='/signUp'>Register Free</Link>
            </div>
            <div className='w-100'>
