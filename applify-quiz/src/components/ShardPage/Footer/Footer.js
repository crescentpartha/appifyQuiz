            ...
            <div className='d-flex flex-wrap gap-5 align-items-top justify-content-around m-0'>
                <div className='d-flex flex-column gap-4 text-start p-0 gap-2'>
                    ...
                    <div className='d-flex gap-4 align-items-center justify-content-start'>
                        <FontAwesomeIcon className='footer-icons fs-4' icon={faFacebook}></FontAwesomeIcon>
                        <FontAwesomeIcon className='footer-icons fs-4' icon={faTwitter}></FontAwesomeIcon>
                        <FontAwesomeIcon className='footer-icons fs-4' icon={faInstagram}></FontAwesomeIcon>
                        <FontAwesomeIcon className='footer-icons fs-4' icon={faYoutube}></FontAwesomeIcon>
                        <FontAwesomeIcon className='footer-icons fs-4' icon={faLinkedin}></FontAwesomeIcon>
                    </div>
